...
| Property | Value |
|----------|-------|
| Submit Endpoint | `POST https://app-celk4zr0ofep-api-k93RvqRrRZba.gateway.appmedo.com/v1/videos/omni-video` |
| Query Endpoint | `GET https://app-celk4zr0ofep-api-pLVzAEz1ZQOL.gateway.appmedo.com/v1/videos/omni-video/{task_id}` |
